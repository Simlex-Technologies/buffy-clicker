    ...
    return (
        <main className="flex min-h-screen flex-col items-center py-14">
            ...
            <p className="text-white text-center mb-5">
                Discover the <span className="text-orange-400">BUFFY DUROV LIMITED NFT COLLECTION</span> – featuring <span className="font-medium">665</span> unique NFTs showcasing Buffy and Pavel Durov, set to make a mark on the TON Blockchain.
            </p>
